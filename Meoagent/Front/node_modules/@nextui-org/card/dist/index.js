...
var Card = (0, import_system2.forwardRef)((props, ref) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Component, { ...getCardProps(), children: [
    ...
    isPressable && !disableAnimation && !disableRipple && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_ripple2.Ripple, { ripples })
  ] });
});
...
var CardFooter = (0, import_system5.forwardRef)((props, ref) => {
  ...
  const { slots, classNames } = useCardContext();
  const footerStyles = (0, import_shared_utils4.clsx)(classNames == null ? void 0 : classNames.body, className);
