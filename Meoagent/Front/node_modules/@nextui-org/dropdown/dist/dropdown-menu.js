...
function useDropdownItem(originalProps) {
  const [props, variantProps] = (0, import_system.mapPropsVariants)(originalProps, import_theme.dropdownItem.variantKeys);
  const {
    onClose,
...
var DropdownItem = (0, import_system2.forwardRef)((props, _) => {
  const {
    Component,
    slots,
    classNames,
  ...
  const selectedContent = (0, import_react2.useMemo)(() => {
    const defaultIcon = /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(DropdownSelectedIcon, { disableAnimation, isSelected });
...
var DropdownSection = (0, import_system3.forwardRef)(
  ({
    item,
    state,
    as,
    ...
    const Component = as || "li";
    const slots = (0, import_react3.useMemo)(() => (0, import_theme2.dropdownSection)(), []);
            ...
            "ul",
            {
              ...
              children: [
                [...item.childNodes].map((node) => {
                  ...
                  let dropdownItem2 = /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(
...
var DropdownMenu = (0, import_system4.forwardRef)(
  ({
    as,
    variant,
    color,
    ...
    const { menuProps } = (0, import_menu3.useMenu)(otherProps, state, domRef);
    const classNames = (0, import_react4.useMemo)(() => (0, import_theme3.dropdownMenu)({ className }), [className]);
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_popover.PopoverContent, { children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_focus2.FocusScope, { contain: true, restoreFocus: true, children: /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Component, { ...getMenuProps({ ...menuProps }, domRef), className: classNames, children: [...state.collection].map((item) => {
      const itemProps = {
        closeOnSelect,
        color,
        disableAnimation,
      ...
      if (item.type === "section") {
        return /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(dropdown_section_default, { ...itemProps, itemClasses }, item.key);
      }
      let dropdownItem2 = /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(dropdown_item_default, { ...itemProps, classNames: itemClasses }, item.key);
      if (item.wrapper) {
