import { DropdownItemVariantProps, SlotsToClasses, DropdownItemSlots } from '@nextui-org/theme';
...
type DropdownItemBaseProps<T extends object = {}> = Props<T> & DropdownItemVariantProps & AriaMenuItemProps & FocusableProps & PressEvents;
declare const DropdownItemBase: (props: DropdownItemBaseProps) => JSX.Element;

export { DropdownItemBaseProps, DropdownItemSelectedIconProps, DropdownItemBase as default };
