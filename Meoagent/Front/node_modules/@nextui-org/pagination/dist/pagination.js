...
function usePagination(originalProps) {
  ...
  const getBaseProps = (props2 = {}) => {
    return {
      ...
      ref: domRef,
      role: "navigation",
      ariaLabel: props2["aria-label"] || "pagination navigation",
      "data-slot": "base",
...
var PaginationItem = (0, import_system2.forwardRef)(({ key, ...props }, ref) => {
  const { Component, children, getItemProps } = usePaginationItem({ ...props, ref });
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Component, { ...getItemProps(), children }, key);
});
