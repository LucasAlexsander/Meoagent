...
declare function useChip(originalProps: UseChipProps): {
    ...
    slots: {
        ...
        avatar: (slotProps?: tailwind_variants.ClassProp<tailwind_variants.ClassValue> | undefined) => string;
        dot: (slotProps?: tailwind_variants.ClassProp<tailwind_variants.ClassValue> | undefined) => string;
